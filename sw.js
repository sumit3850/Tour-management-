...
var CACHE = "ie-ops-v157"; /* v157: quotation / invoice dialogs fit a phone screen (header reflows, policy tables wrap); boot sync pulls before flushing; 7-day keep window for unpushed records */
var SHELL = [
  "config.js",
