...
var CACHE = "ie-ops-v119"; /* v119: per-record merge on sync (newer updatedAt wins, new local records kept, remote deletions honoured); weekly automatic backup + Backup now; money-math test suite */
var SHELL = [
  "config.js",
