...
var CACHE = "ie-ops-v112"; /* v112: mobile cleanup for Tour Cost Sheet (session rate table one-line labels + horizontal scroll, compact action buttons) and Profit Calculator saved rows (aligned profit/edit/delete) */
var SHELL = [
  "config.js",
