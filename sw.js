...
var CACHE = "ie-ops-v146"; /* v146: document header as aligned "Label : value" rows, no bold except the client name, blue Generate invoice, Cancelled status for quotations and leads */
var SHELL = [
  "config.js",
