...
var CACHE = "ie-ops-v133"; /* v133: Overview → Categories — editable tour categories, activities, session types and cost-sheet rate cards; downloadable / re-uploadable cost-sheet template */
var SHELL = [
  "config.js",
