...
var CACHE = "ie-ops-v114"; /* v114: pre-departure checklist with T-minus deadlines + readiness pill on tour cards + overdue-item alerts; 30-day trash for deleted tours/bookings (Tours → Trash) with restore */
var SHELL = [
  "config.js",
