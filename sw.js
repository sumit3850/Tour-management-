...
var CACHE = "ie-ops-v121"; /* v121: theme + column-ruler buttons in the top bar; pipeline stage tabs with counts; pulled guests stay one group under a POC; Past tours column removed; select chevron fix */
var SHELL = [
  "config.js",
