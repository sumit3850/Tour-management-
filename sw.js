...
var CACHE = "ie-ops-v111"; /* v111: group quotation total now equals price-per-person x group size (was raw cost-sheet total), so total/deposit/pending tally exactly */
var SHELL = [
  "config.js",
